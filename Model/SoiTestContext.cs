...
public partial class SoiTestContext : DbContext
{
    public SoiTestContext()
    {
    }

    public SoiTestContext(DbContextOptions<SoiTestContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=tcp:soi-poc.database.windows.net,1433\\soi-test;Initial Catalog=soi-test;Persist Security Info=False;User ID=soi-admin;Password=TanzuPOC1!;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.SystemInformationId).HasName("PK__BuildVer__35E58ECAE7718750");
